...
Содержит поля типа ключ-значение data, binaryData. Ключи data & binaryData не должны пересекаться.
...
ERC-721 - это стандарт невзаимозаменяемого токена (NFT), написанный на языке Solidity в блокчейне Ethereum. Позволяет разработчикам токенизировать владение любыми произвольными данными. В частности, стандарт направлен на создание взаимозаменяемых токенов. Стандарт ERC-721 был создан Уильямом Энтрикеном, Дитером Ширли, Джейкобом Эвансом и Натассией Сакс в 2018 году.
